...
- **Save contract (from Session 2):** every new persistent field goes into `SaveData` in the same commit, with the round-trip test. See skill `save-versioning`.
